...
st.subheader("Here risk free return is considered as 4.25% (average rate of return on a bank deposit)")
...
try:
    ...
    st.write("Please select at least one stock to continue")
